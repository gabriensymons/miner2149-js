...
const staticFiles = [
  ...
  // The favicon set lives at the repository root rather than in a directory of
  // its own, so the paths the page asks for are the paths the dev server and
  // the build both serve -- and so a bare /favicon.ico request, which no <link>
  // controls, resolves. Generated by RealFaviconGenerator; see the manifest.
